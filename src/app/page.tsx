    ...
    <FlowArt>
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col justify-between">
          ...
          {/* Judges Scroll Indicator */}
          <div className="flex flex-col items-center justify-center my-6 z-20">
            <p className="text-[11px] uppercase tracking-[0.4em] text-indigo-400 font-bold mb-3 animate-pulse">
              Attention Judges
            </p>
            <div className="flex items-center gap-2.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-6 py-3 text-xs font-semibold text-indigo-200 backdrop-blur-xl shadow-lg shadow-indigo-500/5 hover:bg-indigo-500/20 transition-all duration-300">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
              </span>
              Scroll Down to Experience FlowArt Story Scroll
            </div>
            <div className="mt-3 animate-bounce">
              <svg className="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
